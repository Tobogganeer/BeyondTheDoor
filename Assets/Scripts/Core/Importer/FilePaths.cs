...
namespace BeyondTheDoor
{
    public static class FilePaths
    {
        ...
        public static readonly string ConversationsRelativeFolderName = Combine("Assets", ConversationsFolderName);
        ...
        {
            if (day == -1)
                return ConversationsRelativeFolderName;
            return Combine(ConversationsRelativeFolderName, "Day " + day);
        }
